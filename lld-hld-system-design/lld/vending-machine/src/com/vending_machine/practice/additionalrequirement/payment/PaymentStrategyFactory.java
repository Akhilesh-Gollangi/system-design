...
import com.vending_machine.practice.additionalrequirement.payment.decorator.CashBackDecorator;
...
public class PaymentStrategyFactory {
    ...
    static {
        ...
        paymentStrategyMap.put(PaymentMethod.SPECIAL_CARD, new SpecialCardPayment());
        paymentStrategyMap.put(PaymentMethod.UPI_REWARD, new CashBackDecorator(new UPIPayment()));
    }
